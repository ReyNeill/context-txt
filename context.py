...
def should_skip_file(file, exclude_files, skip_dot, max_size, file_path):
...
def walk_directory(directory, exclude_dirs, exclude_files, output_file, skip_dot, max_size):
    with open(output_file, 'w', encoding='utf-8') as f:
        for root, dirs, files in os.walk(directory):
            ...
            for file in files:
                ...
                if should_skip_file(file, exclude_files, skip_dot, max_size, file_path):
                    continue
...
if __name__ == "__main__":
    ...
    walk_directory(args.directory, exclude_dirs, exclude_files, args.output, args.skip_dot, args.max_size)
